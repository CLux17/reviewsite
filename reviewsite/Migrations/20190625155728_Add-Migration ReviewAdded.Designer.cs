...
namespace reviewsite.Migrations
{
    ...
    [Migration("20190625155728_Add-Migration ReviewAdded")]
    partial class AddMigrationReviewAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("reviewsite.Model.Review", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Content = "The shoe is the last one of Virgil's Off-White collab for the Air Max 90's and is probably the best design he has to date. They are not true to size and seem to run a half size smaller. The upper's are wonderfully designed, the lower portion in my eye's is where they really shine at. As with all of his Off-White creations as of late, the added print is very reminiscent of Andy Warhol, and I dig it. As far as paying retail for these shoes, they are awesome, but I wouldn't recommend paying resale pricing unless you are okay with wearing shoes that near the thousand dollar mark.", ProductId = 1 },
                        new { Id = 2, Content = "The shoe is as beautiful as it looks on the site. It's does run small so, I would recommend a 1/2 size up. As long as you're used to wearing heels they are good for an all night wear. Perfect for a dramatic night on the town or an elegant night out. Would I recommend this shoe? Absolutely!", ProductId = 2 },
                        new { Id = 3, Content = "Coffee? yes. Iced or Cold brew coffee? Even better. This stuff right here? The best there is, hands down, nothing else wakes me up faster than this.", ProductId = 3 },
                        new { Id = 4, Content = "Feel it withing 15 minutes of drinkning it, fantastic for body building and tastes GREAT!!!!", ProductId = 4 }
                    );
                });
            ...
            modelBuilder.Entity("reviewsite.Model.Review", b =>
                {
                    b.HasOne("reviewsite.Model.Product", "Product")
                        .WithMany("Reviews")
