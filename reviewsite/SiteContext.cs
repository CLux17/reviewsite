        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product()
                {
                    ...
                    Review = "The shoe is as beautiful as it looks on the site. It's does run small so, I would recommend a 1/2 size up. As long as you're used to wearing heels they are good for an all night wear. Perfect for a dramatic night on the town or an elegant night out. Would I recommend this shoe? Absolutely!",
                    CategoryId = 1
                },
                ...
                new Product()
                {
                    ...
                    Image ="coffee.jpg",
                    Review = "Coffee? yes. Iced or Cold brew coffee? Even better. This stuff right here? The best there is, hands down, nothing else wakes me up faster than this.",
                    CategoryId = 2
                },
                ...
                new Product()
                {
                    ...
                    Review = "Feel it withing 15 minutes of drinkning it, fantastic for body building and tastes GREAT!!!!",
                    CategoryId = 2
                }
